...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800">Edit Coupon</h1>
    </div>

    <form action="{{ route('coupons.update', $coupon) }}" method="POST" class="bg-white shadow-sm border border-slate-200 rounded-xl p-6 space-y-6">
        @csrf
        @method('PUT')

...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        <h2 class="text-2xl font-bold text-slate-800">Add Delivery Partner</h2>
        <p class="mt-1 text-sm text-slate-500">Create a new delivery partner for POS checkout.</p>
    </div>
</div>

<form action="{{ route('delivery-partners.store') }}" method="POST" class="max-w-2xl space-y-6">
    @csrf
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-6 space-y-5">
            ...
            <div>
                ...
                <input type="number" name="commission_percentage" id="commission_percentage" value="{{ old('commission_percentage', 0) }}"
